---
title: "Data Science Project - Memes and Music"
author: "Gude, Rich"
date: "Feb, 2020"
output:
  html_document:
...
** Below is the chiunk if programming that takes the DTA and converts it into a dataframe. **

```{r loadData, include=T}
loadPkg('tidyverse')
loadPkg('foreign')
dataDemo <- read.dta('SampleData_Demo.dta')
