...
SEQN			Respondent Sequence Number (primary key)	good
...
RIDRETH1		Race/Ethnicity					good
			(1 - Mexican American, 2 - Other Hispanic,
			 3 - White, 4 - Black, 5 - Other)
DMQMILIT		Veteran/Military Status.  Did you serve?	good
			(1 - Yes, 2 - No, 7 - Refused)
DMDBORN			Country of Birth				IGNORE
DMDCITZN		Citizenship Status				IGNORE
DMDYRSUS		Length of Time in US				IGNORE
DMDEDUC3		Education Level	(for kids)			IGNORE
DMDEDUC2		Education Level (for adults)			IGNORE
...
DMDHSEDY		Household Ref Person's Spouse EduLevel		IGNORE
SIALANG			Language of Sample Person Interview		IGNORE
SIAPROXY		Proxy Used in Sample Person Interview?		IGNORE
...
SDMVPSU			Masked Variance Pseudo-PSU			IGNORE
